...
const AdminGraphicDesign = () => {
  ...
  const loadData = () => {
    ...
    graphicDesignService
      .getSeo()
      .then((res) => {
        console.log("SEO data loaded:", res.data?.data);
        setSeoData(res.data?.data || getDefaultSeoData());
      })
      .catch(() => {
  ...
  const saveSeo = async () => {
    try {
      ...
      await graphicDesignService.updateSeo(seoData);
      showToast("SEO সেটিংস সফলভাবে সেভ হয়েছে!", "success");
    } catch (error) {
      console.error("Error saving SEO data:", error);
      showToast("SEO সেভ করতে সমস্যা হয়েছে!", "error");
    } finally {
      setSaving(false);
    }
  };
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <Input
                ...
                value={data.hero?.cta || ""}
                onChange={(v) =>
                  updateSection("hero", { ...data.hero, cta: v })
                }
          ...
          <div className="space-y-6">
            <div className="mb-4">
              <h3 className="text-lg font-semibold text-gray-700 mb-2">
                পরিসংখ্যান যোগ করুন/সম্পাদনা করুন
              </h3>
              <p className="text-sm text-gray-500">
                ক্লায়েন্ট পেজে পরিসংখ্যান দেখানো হবে
              </p>
            </div>
      ...
      case "processSteps":
        return (
          <div className="space-y-6">
            <div className="mb-4">
              <h3 className="text-lg font-semibold text-gray-700 mb-2">
                কাজের প্রক্রিয়া ধাপসমূহ
              </h3>
              <p className="text-sm text-gray-500">
                প্রতি ধাপে আইকন, শিরোনাম এবং বিবরণ যোগ করুন
              </p>
            </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                    <div>
                      ...
                      <Input
                        value={step.step || ""}
                        onChange={(v) =>
                          updateItem("processSteps", i, "step", v)
                        }
                        placeholder="স্টেপ ১"
                      />
                    </div>
                    ...
                    <div className="md:col-span-2">
                      ...
                      <Input
                        value={step.title || ""}
                        onChange={(v) =>
                          updateItem("processSteps", i, "title", v)
                        }
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="DesignCreationIcon">
                          DesignCreationIcon (ডিজাইন তৈরি)
                        </option>
                        <option value="RevisionFeedbackIcon">
                          RevisionFeedbackIcon (রিভিশন)
                        </option>
                        <option value="FinalDeliveryIcon">
                          FinalDeliveryIcon (ডেলিভারি)
                        </option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    <Textarea
                      ...
                      onChange={(v) =>
                        updateItem("processSteps", i, "description", v)
                      }
        ...
        return (
          <div className="space-y-6">
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-500">
                প্রতিটি পোর্টফোলিও আইটেমে গ্রেডিয়েন্ট ব্যাকগ্রাউন্ড যোগ করুন
              </p>
            </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                      <Input
                        ...
                        value={p.category || ""}
                        onChange={(v) =>
                          updateItem("portfolio", i, "category", v)
                        }
                    ...
                    <div>
                      <SelectGradient
                        ...
                        value={
                          p.gradient || "from-pink-400 via-red-400 to-rose-500"
                        }
                        onChange={(v) =>
                          updateItem("portfolio", i, "gradient", v)
                        }
                      />
                    </div>
                  </div>
        ...
        return (
          <div className="space-y-6">
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-500">
                টুলের নাম, আইকন এবং গ্রেডিয়েন্ট কালার সিলেক্ট করুন
              </p>
            </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                    ...
                    <div className="md:col-span-3">
                      ...
                      <select
                        value={t.icon || ""}
                        onChange={(e) =>
                          updateItem("tools", i, "icon", e.target.value)
                        }
                        className="w-full rounded border border-gray-300 px-3 py-2 text-sm focus:border-purple-500 focus:outline-none"
                      >
                        <option value="">আইকন নির্বাচন করুন</option>
                  ...
                  {(t.icon || t.color) && (
                    <div className="mt-4">
                      ...
                      <div className="flex items-center gap-4">
                        <div
                          className={`w-20 h-20 rounded-full flex items-center justify-center text-white shadow-lg bg-gradient-to-br ${
                            t.color || "from-blue-500 to-indigo-600"
                          }`}
                        >
                          {(() => {
                            const IconComponent = getIconComponent(
        ...
        return (
          <div className="space-y-6">
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-500">
                প্রতিটি প্যাকেজের বিস্তারিত তথ্য এবং ফিচারস যোগ করুন
              </p>
            </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-4">
                    ...
                    <div className="md:col-span-4">
                      <Input
                        ...
                        value={pkg.duration || ""}
                        onChange={(v) =>
                          updateItem("packages", i, "duration", v)
                        }
                  ...
                  <div className="mb-4">
                    <Input
                      ...
                      onChange={(v) =>
                        updateItem("packages", i, "button_link", v)
                      }
                  ...
                  <div className="mb-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <button
                        onClick={() =>
                          updateItem("packages", i, "features", [
                            ...(pkg.features || []),
                            "",
                          ])
                        }
                    ...
                    >
                      ...
                      <div className="space-y-2 mb-6">
                        ...
                        {(pkg.features || []).length > 3 && (
                          <div className="text-sm opacity-80">
                            + আরও {(pkg.features || []).length - 3} ফিচার
                          </div>
                        )}
                      </div>
                      <div
            ...
            <div className="mt-6 p-6 bg-gradient-to-r from-purple-600 to-pink-600 rounded-lg text-white">
              <div className="text-center">
                <h3 className="text-2xl font-bold mb-3">
                  {data.cta?.title || "শিরোনাম"}
                </h3>
                <p className="mb-6 opacity-90">
                  {data.cta?.description || "বিবরণ"}
                </p>
                  ...
                  <div>
                    <label className="flex items-center gap-2 text-sm font-medium text-gray-700">
                      <input
                        type="checkbox"
                        checked={
                          seoData?.meta_robots_index === 1 ||
                          seoData?.meta_robots_index === true
                        }
                        onChange={(e) =>
                          updateSeoField(
                            "meta_robots_index",
                  ...
                  <div>
                    <label className="flex items-center gap-2 text-sm font-medium text-gray-700">
                      <input
                        type="checkbox"
                        checked={
                          seoData?.meta_robots_follow === 1 ||
                          seoData?.meta_robots_follow === true
                        }
                        onChange={(e) =>
                          updateSeoField(
                            "meta_robots_follow",
              ...
              <div className="space-y-4">
                <div>
                  ...
                  >
                    ...
                    <option value="0.8">०.८</option>
                    <option value="0.7">०.७</option>
                    <option value="0.5">०.५ (মধ্যম)</option>
                  </select>
                </div>
                <div>
                  <label className="mb-1 block text-sm font-medium text-gray-700">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-sm text-gray-500 ml-auto">
                  {(() => {
                    const items =
                      data[tabs.find((tab) => tab.id === activeTab)?.id];
...
const SelectGradient = ({ label, value, onChange }) => {
  const gradients = [
    {
      value: "from-pink-400 via-red-400 to-rose-500",
      label: "গোলাপি-লাল-গোলাপ (Pink-Red-Rose)",
    },
    {
      value: "from-blue-400 via-purple-400 to-pink-500",
      label: "নীল-বেগুনি-গোলাপি (Blue-Purple-Pink)",
    },
    {
      value: "from-yellow-300 via-amber-400 to-orange-500",
      label: "হলুদ-এম্বার-কমলা (Yellow-Amber-Orange)",
    },
    {
      value: "from-green-400 via-teal-400 to-blue-500",
      label: "সবুজ-টিল-নীল (Green-Teal-Blue)",
    },
    {
      value: "from-blue-500 to-indigo-600",
      label: "নীল-ইন্ডিগো (Blue-Indigo)",
    },
    { value: "from-pink-500 to-rose-600", label: "গোলাপি-গোলাপ (Pink-Rose)" },
    {
      value: "from-purple-500 to-indigo-600",
      label: "বেগুনি-ইন্ডিগো (Purple-Indigo)",
    },
    ...
    { value: "from-blue-500 to-purple-600", label: "নীল-বেগুনি (Blue-Purple)" },
    {
      ...
      label: "বেগুনি-গোলাপি (Purple-Pink)",
    },
    ...
    { value: "from-red-500 to-orange-500", label: "লাল-কমলা (Red-Orange)" },
    {
      ...
      label: "ইন্ডিগো-বেগুনি (Indigo-Purple)",
    },
