...
const ChatbotSVG = () => {
  return (
    ...
    >
      <style>
        {`
          /* Keyframes for the simple bounce animation */
          @keyframes bounce {
            0%, 100% {
          ...
          /* Apply the animation to the main group of elements */
          .chatbot-bounce {
            animation: bounce 2s infinite ease-in-out;
            transform-origin: center bottom; /* Ensure it bounces from the bottom */
          }
        `}
      </style>


      {/* Main Group for Animation - Everything inside will bounce */}
      <g className="chatbot-bounce">
        <g>
          <linearGradient
            id="SVGID_1_"
            ...
            y2="232.6981"
          >
            <stop offset="0" style={{ stopColor: "#AEF0EB" }} />
            <stop offset="0.0131" style={{ stopColor: "#B0F0EB" }} />
            <stop offset="0.1379" style={{ stopColor: "#C2F4EB" }} />
            <stop offset="0.2895" style={{ stopColor: "#CEF6EA" }} />
            <stop offset="0.4961" style={{ stopColor: "#D5F8EA" }} />
            <stop offset="1" style={{ stopColor: "#D7F8EA" }} />
          </linearGradient>
          <path
            style={{ fill: "url(#SVGID_1_)" }}
            d="M161.472,200.096c0,0,2.075,27.956,13.709,34.554c0,0-37.353-6.451-46.538-20.44
          ...
          <linearGradient
            ...
            x2="205.8182"
            y2="244.7011"
            gradientTransform="matrix(0.1117 0.9937 -0.9937 0.1117 521.1897 134.5915)"
          >
            <stop offset="0.0397" style={{ stopColor: "#06BED8" }} />
            <stop offset="1" style={{ stopColor: "#DEFA8E" }} />
          </linearGradient>
          <path
          ...
          <linearGradient
            ...
            y2="143.2557"
          >
            <stop offset="0.0397" style={{ stopColor: "#06CFF1" }} />
            <stop offset="1" style={{ stopColor: "#DEFA8E" }} />
          </linearGradient>
          ...
          <path
            style={{ fill: "url(#SVGID_4)" }}
            d="M284.21,177.775h-33.834
          ...
          <linearGradient
            ...
            y2="204.7225"
          >
            <stop offset="0" style={{ stopColor: "#030D14" }} />
            <stop offset="1" style={{ stopColor: "#0B2F45" }} />
          </linearGradient>
          <path
            style={{ fill: "url(#SVGID_6)" }}
            d="M319.862,244.693L319.862,244.693
          ...
          <g>
            <radialGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop offset="0.1296" style={{ stopColor: "#3280FC" }} />
              <stop offset="1" style={{ stopColor: "#000000" }} />
            </radialGradient>
            <circle
              style={{ fill: "url(#SVGID_7)" }}
              cx="243.032"
              cy="225.079"
              r="17.358"
            />
            ...
            <g>
              <path
                style={{ fill: "#EEFDFF" }}
                d="M249.735,222.367c0,2.141-1.735,3.876-3.876,3.876c-2.141,0-3.876-1.736-3.876-3.876
            ...
            <g>
              <path
                style={{ fill: "#EEFDFF" }}
                d="M237.649,230.783c0,0.427-0.346,0.773-0.773,0.773c-0.427,0-0.773-0.346-0.773-0.773
          ...
          <g>
            ...
            <g>
              <path
                style={{ fill: "#EEFDFF" }}
                d="M296.628,222.367c0,2.141-1.736,3.876-3.876,3.876s-3.877-1.736-3.877-3.876
            ...
            <g>
              <path
                style={{ fill: "#EEFDFF" }}
                d="M284.541,230.783c0,0.427-0.346,0.773-0.773,0.773c-0.427,0-0.773-0.346-0.773-0.773
          ...
          <path
            style={{ fill: "#FFFFFF" }}
            d="M271.656,123.276c0,1.057-0.857,1.913-1.914,1.913c-1.057,0-1.914-0.857-1.914-1.913
            c0-1.057,0.857-1.914,1.914-1.914C270.799,121.363,271.656,122.219,271.656,123.276z"
          />
          <path
            style={{ fill: "#FFFFFF" }}
            d="M321.337,186.878c0.083,2.93-2.309,6.435-5.049,6.734c-2.568,0.281-4.619-2.343-6.734-5.049
          ...
          <path
            style={{ fill: "#FFFFFF" }}
            d="M321.026,227.526c-0.7,0.494-5.579-9.446-18.677-18.064c-4.604-3.03-9.149-5.189-8.879-5.817
            c0.274-0.637,5.393,0.548,9.491,2.449C316.019,212.152,321.858,226.939,321.026,227.526z"
          />
          <path
            style={{ fill: "#FFFFFF" }}
            d="M287.486,162.903c-0.156,0.022-0.256-0.895-1.02-2.312c0,0-0.357-0.663-0.765-1.225
          ...
          <path
            style={{ fill: "#EEFDFF" }}
            d="M286.042,253.654c-0.17,1.663-1.554,2.944-3.218,3.104l-22.994,2.217
          ...
          <linearGradient
            ...
            y2="232.1873"
          >
            <stop offset="0.0714" style={{ stopColor: "#0DA9AB" }} />
            <stop offset="1" style={{ stopColor: "#DEFA8E" }} />
          </linearGradient>
          <path
            style={{ fill: "url(#SVGID_12)" }}
            d="M286.043,253.656
          ...
          >
            <stop offset="0.0397" style={{ stopColor: "#06CFF1" }} />
            <stop offset="0.0408" style={{ stopColor: "#06CFF1" }} />
            <stop offset="0.1607" style={{ stopColor: "#37D9DB" }} />
            <stop offset="0.2745" style={{ stopColor: "#5DE0CA" }} />
            <stop offset="0.3793" style={{ stopColor: "#78E6BD" }} />
            <stop offset="0.4719" style={{ stopColor: "#88E9B6" }} />
            <stop offset="0.5423" style={{ stopColor: "#8EEAB3" }} />
            <stop offset="0.8004" style={{ stopColor: "#B9F39F" }} />
            <stop offset="1" style={{ stopColor: "#DEFA8E" }} />
          </linearGradient>
          <path
            style={{ fill: "url(#SVGID_13)" }}
            d="M322.271,305.299
          ...
          <path
            style={{ fill: "url(#SVGID_14)" }}
            d="M271.114,287.401l-30.761,0.129
          ...
          <linearGradient
            ...
            x2="445.2136"
            y2="321.0547"
            gradientTransform="matrix(-0.9886 -0.1505 -0.1505 0.9886 765.7411 45.2856)"
          >
            <stop offset="0.0397" style={{ stopColor: "#06CFF1" }} />
            <stop offset="0.0734" style={{ stopColor: "#0FD1ED" }} />
            <stop offset="0.4151" style={{ stopColor: "#67E2C5" }} />
            <stop offset="0.6937" style={{ stopColor: "#A7EFA7" }} />
            <stop offset="0.8955" style={{ stopColor: "#CFF795" }} />
            <stop offset="1" style={{ stopColor: "#DEFA8E" }} />
          </linearGradient>
          <path
            style={{ fill: "url(#SVGID_15)" }}
            d="M301.687,332.72
          ...
          <path
            style={{ fill: "#FFFFFF" }}
            d="M319.542,312.85c-0.135-2.564-0.616-4.449-1.578-8.221c-1.258-4.934-2.836-7.339-1.811-8.292
          ...
          <path
            style={{ fill: "#FFFFFF" }}
            d="M322.639,321.899c0,0.517-0.419,0.936-0.936,0.936c-0.517,0-0.936-0.419-0.936-0.936
          ...
          <radialGradient
            ...
            cy="259.9652"
            r="48.488"
            gradientTransform="matrix(1.012 0 0 0.4143 -2.4574 280.8518)"
            gradientUnits="userSpaceOnUse"
          >
            <stop offset="0" style={{ stopColor: "#BCD7D6" }} />
            <stop offset="1" style={{ stopColor: "#FFFFFF" }} />
          </radialGradient>


          <ellipse
            style={{ fill: "url(#SVGID_17)" }}
            cx="269.742"
            cy="388.555"
            rx="49.07"
            ry="20.089"
          ...
          <linearGradient
            ...
            y2="166.7528"
          >
            <stop offset="0" style={{ stopColor: "#D7F8EA" }} />
            <stop offset="0.5053" style={{ stopColor: "#ECF8F2" }} />
            <stop offset="1" style={{ stopColor: "#D7F8EA" }} />
          </linearGradient>
          <path
            style={{ fill: "url(#SVGID_18)" }}
            d="M133.55,214.21H66.49
          ...
          <g>
            <linearGradient
              ...
              x2="175.7228"
              y2="141.1934"
              gradientTransform="matrix(0.9989 -0.0459 0.0459 0.9989 -8.1114 5.7791)"
            >
              <stop offset="0.0397" style={{ stopColor: "#06CFF1" }} />
              <stop offset="1" style={{ stopColor: "#DEFA8E" }} />
            </linearGradient>
            <path
              style={{ fill: "url(#SVGID_19)" }}
              d="M69.94,184.913
          ...
          <path
            style={{ fill: "#FFFFFF" }}
            d="M155.14,167.023c0,0-1.899-17.199-0.955-17.668C155.129,148.887,155.578,158.281,155.14,167.023z"
          />
          <path
            style={{ fill: "#FFFFFF" }}
            d="M157.022,175.708c0,0.571-0.463,1.033-1.033,1.033c-0.571,0-1.033-0.463-1.033-1.033
            c0-0.571,0.463-1.033,1.033-1.033C156.559,174.675,157.022,175.138,157.022,175.708z"
          />
          <path
            style={{ fill: "#FFFFFF" }}
            d="M143.49,168.176c0.006-0.959-0.109-3.693-2.094-5.909c-1.707-1.905-3.99-2.527-5.029-2.406
            c-0.198,0.023-0.87,0.139-0.914,0.42c-0.091,0.581,2.654,0.987,4.707,2.526C141.309,163.667,142.671,165.205,143.49,168.176z"
          />
          <path
            style={{ fill: "#FFFFFF" }}
            d="M116.769,150.365c1.055-0.01,1.457,19.278,1.15,22.767
            C117.612,176.621,116.344,150.369,116.769,150.365z"
          />
          <path
            style={{ fill: "#FFFFFF" }}
            d="M92.908,166.88c-0.462-2.608-3.439-5.536-5.297-5.078c-1.859,0.458,2.202,1.868,3.658,3.126
            C92.724,166.187,92.908,166.88,92.908,166.88z"
          />
          <path
            style={{ fill: "#FFFFFF" }}
            d="M76.594,181.735c2.159,2.394,5.243,2.856,5.286,2.754c0.046-0.107-3.377-0.566-5.177-3.314
            c-0.847-1.292-1.686-3.626-2.244-3.627c-0.013,0-0.035,0.001-0.055,0.016C74.118,177.771,75.211,180.202,76.594,181.735z"
          />
          <path
            style={{ fill: "#FFFFFF" }}
            d="M68.688,181.248c-0.689,0.946-0.781-23.395-1.222-25.774c0,0,0,0,0-0.156
        ...
        <path
          style={{ fill: "#FFFFFF" }}
          d="M175.051,154.989c-1.054,0.783-8.394-13.425-26.723-23.163c-10.312-5.478-18.724-6.685-18.504-7.68
        ...
        <path
          style={{ fill: "#FFFFFF" }}
          d="M97.78,124.359c0,0.598-1.067,1.083-2.384,1.083c-1.317,0-2.384-0.485-2.384-1.083
          c0-0.598,1.067-1.083,2.384-1.083C96.713,123.276,97.78,123.761,97.78,124.359z"
        />
        <path
          style={{ fill: "#FFFFFF" }}
          d="M51.624,159.666c0.173,3.067,0.146,5.563-0.061,5.575c-0.207,0.012-0.515-2.465-0.688-5.533
          c-0.173-3.067-0.146-5.563,0.061-5.575C51.143,154.122,51.451,156.599,51.624,159.666z"
        />
        <path
          style={{ fill: "#FFFFFF" }}
          d="M163.667,220.333c1.431,4.018,2.929,6.366,2.583,6.583c-0.39,0.245-2.971-2.312-4.5-5.667
